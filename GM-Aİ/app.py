...
def take_action():
    ...
    # Build turn prompt with rule anchor, GM directives, and deterministic physics directives
    ...
    # Construct conversation history (keep last 8 turns to avoid context overflow while keeping immediate memory)
