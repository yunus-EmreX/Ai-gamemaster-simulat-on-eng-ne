...
class SimulationCore:
    ...
    def enforce_turn(
        ...
        """
        Post-LLM Deterministik Kural Uygulama Aşaması.
        LLM'in ürettiği turn_json verisini kural motorundan geçirerek zorunlu
        fizik, envanter ve biyolojik sınırları uygular.
        """
        from core.rule_enforcer import RuleEnforcer
        return RuleEnforcer.enforce_post_turn(game_state, player_action, turn_json, sim_eval)